...
export const PLAYER_PATHFINDING_MAX_ITERATIONS = 4000;
export const PLAYER_PATHFINDING_ITERATIONS_PER_HEX = 32;
export const ROLLING_TERRAIN_PATCH_RADIUS = 3;
export const ROLLING_TERRAIN_PATCHES_PER_FRAME = 3;
...
export const ENEMY_FALLBACK_QUEUE_TIMEOUT_SECONDS = 2;
export const ENEMY_FALLBACK_GOAL_STALE_CELLS = 3;
export const ENEMY_FALLBACK_REJOIN_PROGRESS_CELLS = 1;
export const NAVIGATION_FRAME_BUDGET_MS = 2.5;
export const NAVIGATION_WORK_QUANTUM_MS = 0.5;
export const NAVIGATION_FLOW_MAX_NODES_PER_SLICE = 64;
export const NAVIGATION_PATH_MAX_NODES_PER_SLICE = 24;
export const NAVIGATION_LINE_MAX_CELLS_PER_SLICE = 8;
export const PLAYER_PATH_RETRY_COOLDOWN_SECONDS = 0.2;
