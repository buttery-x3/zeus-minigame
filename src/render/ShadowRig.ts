...
export class ShadowRig {
  ...
  constructor(private readonly scene: THREE.Scene) {
    ...
    this.light.shadow.camera.left = -SHADOW_SIZE / 2;
    this.light.shadow.camera.right = SHADOW_SIZE / 2;
    this.light.shadow.camera.top = SHADOW_SIZE / 2;
    this.light.shadow.camera.bottom = -SHADOW_SIZE / 2;
