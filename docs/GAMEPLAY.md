...
- Rivers and cliffs use authored endpoints, mirrored sways, asymmetric dog-legs, tight bends, gentle bends, and junctions instead of choosing only straight lines or sharp turns. Lakes retain their existing authored coves, shores, basins, cores, and transitions. A hard micro-cell topology rule prevents walls, rivers, and lakes—individually or in combination—from enclosing walkable or ungenerated terrain. Among candidates that satisfy that rule, avoidable small river or cliff loops and near-closures remain suppressed as an aesthetic preference.
