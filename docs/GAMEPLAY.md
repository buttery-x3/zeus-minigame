...
- Terrain cells are generated by a local grammar that commits one 7-hex pattern at a time: center hex plus six neighbors. New patterns must agree with already committed terrain.
