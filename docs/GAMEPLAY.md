...
- Gameplay visibility is tracked separately from Three.js render lighting. Zeus has a world light radius with wall-aware hex field of view, per-cell light falloff, permanent discovered navigation memory, and void treatment for unlit cells. The rendered fog overlay follows Zeus continuously and smooths alpha history, while gameplay visibility remains hex-cell authoritative.
