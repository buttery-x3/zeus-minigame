...
- Checks rolling patch terrain diagnostics, including authored-first selection, budgeted frontier generation timing, expanded bend topology, zero patch-generated banks, active short-loop suppression, zero movement enclosures, zero synthesis failures or emergency patches, and ordered patch edge socket agreement.
