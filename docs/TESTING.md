...
- Checks that core HUD text and ability buttons exist, including the Unlock UI toggle, locked transparent vitals/abilities panels, click-through behavior, gated hover reveal, and radial spell cooldown button state.
