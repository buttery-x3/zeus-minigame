...
- Loads the skinned Zeus GLB and checks its exact animation inventory, `Idle_8` default, `Run_03` movement, Q/W cast clips, pause freeze, `Dead` defeat, and restart back to idle through runtime diagnostics.
