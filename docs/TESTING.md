...
- Confirms special ground creates no ambient particle systems, throttles ambient glyph updates to 5 Hz, and uses exactly one seven-point particle object only while Zeus occupies an active charged or cursed tile.
