...
- Checks terrain grammar diagnostics, including committed pattern usage and the absence of invalid local samples such as wall-water adjacency, isolated river/lake cells, or orphan banks.
